...
require_once 'bitpay/bp_options.php';
...
$cart = Cart66Session::get('Cart66Cart');
 ...
 <form action="" method='post' id="tco_shipping_form" class="phorm2
    ...
    ?>">
    <input type="hidden" name="cart66-task" value="bitpay" />
    ...
    <ul>
      ...
      <li>
        ...
        <?php else: ?>
          <input class="Cart66CheckoutButton" type="image" src='https://bitpay.com/img/button5.png' value="<?php _e( 'Continue' , 'cart66' ); ?>" name="Complete Order"/>
        <?php endif; ?>
      </li>
